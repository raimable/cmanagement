...
if (!isset($_SESSION['query'])) {
    $_SESSION['query'] = serialize($daoFactory->getRoleDAO()->queryAll());
    $_SESSION['view'] = serialize('All Role');
}
if (isset($_POST['btnFilterByKeyword'])) {
    $_SESSION['query'] = serialize($daoFactory->getRoleDAO()->searchByKeyword($_POST['keyword'])); 
        ...
        if ($customer_query) {
            ...
            <form id="records" name="records" method="POST" action="">
                <table class="adminlist">
                     <thead>
                        <tr>
                            ...
                            <th width="20%" class="left">
                                <a href="">Role Name</a></th>
                             <th width="35%" class="left">
                                <a href="">Role Description</a></th>
                            </tr>
                    </thead>
                    <?php
                    $start = 1;
                    ...
                    foreach ($customer_query as $role) {
                ...
                if ($i % 2 == 0) {
                    ...
                    echo '1';
                            ...
                            ?>">
                                    <td class="center">
                                        <?php echo $index; ?></td>
                                    <td class="normal"><a href="update.php?id=<?php echo $role->roleId ?>"><?php echo $role->roleName; ?></a></td>
                                    
                                    <td class="normal"><?php echo $role->roleDescription; ?></td>
                                  </tr>
