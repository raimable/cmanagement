...
if (!isset($_SESSION['query'])) {
    $_SESSION['query'] = serialize($daoFactory->getCustomerDAO()->queryAllWithValidContract());
                ...
                if ($i % 2 == 0) {
                    ...
                    echo '1';
                            ...
                            ?>">
                                    <td class="center">
                                        <?php echo $index; ?></td>
                                    <td class="normal"><a href="add.php?id=<?php echo $consumption->customerId; ?>"><?php echo $consumption->names; ?> </a></td>
