...
if (!isset($_SESSION['query'])) {
    $_SESSION['query'] = serialize($daoFactory->getServiceDAO()->queryAll());
    $_SESSION['view'] = serialize('All services');
}
if (isset($_POST['btnFilterByKeyword'])) {
    $_SESSION['query'] = serialize($daoFactory->getServiceDAO()->searchByKeyword($_POST['keyword']));
...
if ($customer_query) {
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="10%" class="left">
                                <a href="">Service Description</a></th>
    ...
    foreach ($customer_query as $service) {
        if ($j >= $start && $j < $start + $pagination->record_per_page) {
            ...
            ?>">
                                    <td class="center">
                                    <?php echo $index; ?></td>
                                    <td class="normal"><a href="update.php?id=<?php echo $service->serviceId; ?>"><?php echo $service->serviceDescription; ?></a></td>
