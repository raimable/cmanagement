...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb" lang="en-gb" dir="ltr" >
    <head>
        ...
        <tr> 
            <td border="0" bdcolor=white > <img src="../pages/header.jpg" alt="Welcome to Umuhuza" width="100%" height="80" /> </td>  </tr> 
    ...
    <body id="minwidth-body">
        ...
        <div id="header-box">
            ...
            <div id="module-status">
                ...
                <span class="loggedin-users">User : <?php echo ' <strong> '.$_COOKIE['username']. '</strong> '; ?><a href="../pages/index.php">Logout</a></span>
            </div>
            <div class="clr"></div>
