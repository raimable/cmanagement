...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2014 at 01:55 PM
...
(1, 'GISODA ND Albert', '19868753113', 'gisa@y.fr', '0788694559', '466-895687-06', 'Bank of Kigali', '0000-00-00', '0000-00-00', 200),
...
(9, 'Aimable Rukundo Test Update', '119865000851', 'raimablegmail.com', '0788694559', '466-895687-06', 'Bank of Kigali', '2014-08-08', '2014-08-05', 4000000);
...
(1, 'Aimable Rukundo', 'raimable', 'a7417776f6680ce49d3cb6f580e90f9d', 3),
(2, 'Albert Gisoda123', 'agisoda123', '793ad97332dc17c54439428db800f67a', 2),
(3, 'Albert Gisoda', 'agisoda', 'a05783f07a0c24763903298e936e83be', 2),
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `roleId` FOREIGN KEY (`userId`) REFERENCES `role` (`roleId`) ON DELETE CASCADE ON UPDATE CASCADE;
