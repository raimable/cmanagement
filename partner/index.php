...
if (!isset($_SESSION['query'])) {
    $_SESSION['query'] = serialize($daoFactory->getPartnerDAO()->queryAll());
    $_SESSION['view'] = serialize('All customers');
}
...
if ($customer_query) {
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="20%" class="left">
                                <a href="">Partner Name</a></th>
                            <th width="10%" class="left">
                                <a href="">Partner Bank Account</a></th>
                            <th width="10%" class="left">
                                <a href="">Account Provider</a></th>
                            <th width="10%" class="left">
                                <a href="">Services</a></th>
    ...
    foreach ($customer_query as $partner) {
        if ($j >= $start && $j < $start + $pagination->record_per_page) {
            ...
            ?>">
                                    <td class="center">
                                    <?php echo $index; ?></td>
                                    <td class="normal"><a href="update.php?id=<?php echo $partner->partnerId; ?>"><?php echo $partner->partnerName; ?> </a></td>

                                    <td class="normal"><?php echo $partner->bankAccount; ?></td>
                                    <td class="normal"><?php echo $partner->bankAcoountProvider; ?></td>
                                    <td class="normal"><?php echo $daoFactory->getServiceDAO()->load($partner->serviceId)->serviceDescription; ?></td>
                                  </tr>
